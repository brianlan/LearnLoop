...
def test_settings_load_from_environment(monkeypatch) -> None:
    ...
    monkeypatch.setenv("HELPER_VLM_PROVIDER", "ollama")
    ...
    monkeypatch.setenv("MATH_INGESTION_VLM_PROVIDER", "ollama")
    ...
    monkeypatch.setenv("ENGLISH_INGESTION_VLM_PROVIDER", "ollama")
    ...
    monkeypatch.setenv("GRADING_VLM_PROVIDER", "ollama")
    ...
    monkeypatch.setenv("MATH_SOLUTION_VLM_PROVIDER", "ollama")
    ...
    monkeypatch.setenv("ENGLISH_SOLUTION_VLM_PROVIDER", "ollama")
    ...
    monkeypatch.setenv("MATH_COACHING_VLM_PROVIDER", "ollama")
    ...
    monkeypatch.setenv("ENGLISH_COACHING_VLM_PROVIDER", "ollama")
    ...
    assert settings.helper_vlm_provider == "ollama"
    ...
    assert settings.math_ingestion_vlm_provider == "ollama"
    ...
    assert settings.english_ingestion_vlm_provider == "ollama"
    ...
    assert settings.grading_vlm_provider == "ollama"
    ...
    assert settings.math_solution_vlm_provider == "ollama"
    ...
    assert settings.english_solution_vlm_provider == "ollama"
    ...
    assert settings.math_coaching_vlm_provider == "ollama"
    ...
    assert settings.english_coaching_vlm_provider == "ollama"
...
def test_settings_defaults_when_environment_missing(monkeypatch) -> None:
    for key in [
        ...
        "ENGLISH_INGESTION_VLM_PROVIDER",
        "GRADING_VLM_ENDPOINT",
        "GRADING_VLM_MODEL",
        "GRADING_VLM_API_KEY",
        "GRADING_VLM_TIMEOUT_SECONDS",
        "GRADING_VLM_PROVIDER",
    ...
    assert settings.helper_vlm_provider == "openai"
    ...
    assert settings.math_ingestion_vlm_provider == "openai"
    ...
    assert settings.english_ingestion_vlm_provider == "openai"
    ...
    assert settings.grading_vlm_provider == "openai"
    ...
    assert settings.math_solution_vlm_provider == "openai"
    ...
    assert settings.english_solution_vlm_provider == "openai"
    ...
    assert settings.math_coaching_vlm_provider == "openai"
    ...
    assert settings.english_coaching_vlm_provider == "openai"
